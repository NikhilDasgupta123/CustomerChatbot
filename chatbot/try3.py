...
def main():
    ...
    if "username" in st.session_state:
        ...
        if st.button("End Chat"):
            thank_you_message = "Thank you for chatting with us! If you have any more questions, feel free to reach out again. Have a great day!"
            st.session_state.chat_history.append(AIMessage(content=thank_you_message))
